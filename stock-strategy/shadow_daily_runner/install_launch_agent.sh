...
chip_repo_plist="/Users/linyunyan/Downloads/WarrantScope_tracker_web_v1_2026-09-01_COMPLETE/stock-strategy/shadow_daily_runner/launchd/com.linyunyan.warrantscope.chip-watch.plist"
chip_installed_plist="/Users/linyunyan/Library/LaunchAgents/com.linyunyan.warrantscope.chip-watch.plist"
...
chip_label="com.linyunyan.warrantscope.chip-watch"
user_id="$(/usr/bin/id -u)"

/usr/bin/plutil -lint "${repo_plist}"
/usr/bin/plutil -lint "${preflight_repo_plist}"
/usr/bin/plutil -lint "${chip_repo_plist}"
...
/usr/bin/install -m 0644 "${chip_repo_plist}" "${chip_installed_plist}"
